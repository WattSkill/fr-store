...
RMenu.Add(
    "store",
    "mainmenu",
    RageUI.CreateMenu("", "Inventory", tFR.getRageUIMenuWidth(), tFR.getRageUIMenuHeight(), "fr_storeui", "fr_storeui")
)
RMenu.Add(
    "store",
    "info",
...
RMenu.Add(
    "store",
    "redeem",
    RageUI.CreateSubMenu(RMenu:Get("store", "info"), "", "Redeem", tFR.getRageUIMenuWidth(), tFR.getRageUIMenuHeight())
)
RMenu.Add(
    "store",
    "vehicleList",
...
local function a2(K)
    l = true
    TriggerServerEvent("FR:setInVehicleTestingBucket", true)
    z = tFR.getPlayerCoords()
    w = 1
    ...
    m = tFR.spawnVehicle(K, a4.x, a4.y, a4.z, a5, true, false, false)
    n = GetGameTimer()
end
                ...
                function()
                    ...
                    if next(b) then
                        ...
                        RageUI.ButtonWithStyle(
                            ...
                            function(m, q, r)
                                if r then
                                    tFR.OpenUrl("https://store.frstudios.co.uk/")
                                end
                            end
                        )
                    end
                ...
                function()
                    ...
                    if U.manuallyRedeemable then
                        RageUI.ButtonWithStyle(
                            ...
                            function(X, Y, Z)
                                if Z then
                                    TriggerServerEvent("FR:getStoreLockedVehicleCategories")
                                end
                            end,
                            RMenu:Get("store", "redeem")
                        )
                        ...
                        RageUI.ButtonWithStyle(
                            ...
                            function(m, q, r)
                                if r then
                                    tFR.OpenUrl("https://discord.gg/ZfXz8S6uF5")
                                end
                            end
                        )
                    end
                            ...
                            function(X, Y, Z)
                                if Z then
                                    if isInGreenzone then
                                        TriggerServerEvent("FR:startSellStoreItem", d)
                                    else
                ...
                function()
                    ...
                    RageUI.ButtonWithStyle(
                        ...
                        function(X, Y, Z)
                            if Z then
                                if T(U) then
                                    TriggerServerEvent("FR:redeemStoreItem", d, e)
                                else
                ...
                function()
                    ...
                    RageUI.ButtonWithStyle(
                        ...
                        function(X, Y, Z)
                            if Z then
                                if
                                    tFR.canAnim() and tFR.getPlayerCombatTimer() == 0 and tFR.getPlayerVehicle() == 0 and
                                        not tFR.isPlayerInRedZone() and
                                        tFR.getPlayerBucket() == 0
                                 then
                                    a2(g)
                                else
...
RMenu.Add(
    "vehicletesting",
    "mainmenu",
    RageUI.CreateMenu("", "Main Menu", tFR.getRageUIMenuWidth(), tFR.getRageUIMenuHeight(), "fr_storeui", "fr_storeui")
)
RMenu.Add(
    "vehicletesting",
    "extras",
                    ...
                    RageUI.ButtonWithStyle(
                        ...
                        function(X, Y, Z)
                            if Z then
                                ...
                                TriggerServerEvent("FR:setInVehicleTestingBucket", false)
...
local function az()
    if l then
        ...
        local vehicle, aA = tFR.getPlayerVehicle()
...
tFR.createThreadOnTick(az)
function tFR.isInStoreTesting()
    return l
end
RegisterNetEvent(
    "FR:storeDrawEffects",
    function()
        tFR.loadPtfx("scr_xs_celebration")
        tFR.loadPtfx("scr_rcpaparazzo1")
        for I = 1, 4 do
            local a4 = tFR.getPlayerCoords()
...
RegisterNetEvent(
    "FR:setStoreLockedVehicleCategories",
    function(aB)
        c = aB
    end
)
RegisterNetEvent("FR:OpenStoreMenu")
AddEventHandler(
    "FR:OpenStoreMenu",
    function()
...
RegisterCommand(
    "store",
    function()
        TriggerServerEvent("FR:OpenStore")
    end
)
RegisterNetEvent(
    "FR:setStoreRankName",
